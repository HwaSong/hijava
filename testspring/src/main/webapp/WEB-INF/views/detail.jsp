  ...
  <div class="content-wrapper">
	...
	<div class="box">
		...
		<div class="box-footer">
			<button class="btn btn-success" id="btn-success">메인</button>
			<button class="btn btn-warning" id="btn-warning">수정</button>
			<button class="btn btn-danger" id="btn-danger">삭제</button>
			<button class="btn btn-primary" id="btn-primary">목록</button>
			<button class="btn btn-info" id="btn-info">댓글작성</button>
		</div>
